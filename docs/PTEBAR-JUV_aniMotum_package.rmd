...
require(viridis)
```
Ici sont présentés les valeurs fittées et prédites (time.step == c(1, 3, 6, 12, 24) h) issues d'un SSM "move persistence", avec une vitesse maximale de 60 km/h (vitesse remplacée par 110 km/h dans les prochains modèles).
