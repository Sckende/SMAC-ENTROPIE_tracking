...
tabb2 <- as.data.frame(readRDS("C:/Users/ccjuhasz/Desktop/SMAC/Projet_publi/X-PTEBAR_argos_JUV/DATA/RMD/PTEBAR_JUV_Bilan_ARGOS_data.rds"))[, c(1, 2, 4:8, 10:14, 15)]



r <- apply(tabb2[, c(4:7, 10:11)],
           2,
           round,
           digits = 2)


tabb3 <- cbind(tabb2[, -c(4:7, 10:11)], r)

tabb3 <- tabb3[, c(7, 1:3, 8:11, 13, 5, 12, 6)]
