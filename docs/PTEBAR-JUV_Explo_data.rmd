...
tabb3 <- dplyr::left_join(tabb[, c('Vessel', 'geometry')], tabb2, by = 'Vessel')

# Round numerical values
tabb4 <- cbind(tabb3[, c(1:3, 10)], apply(as.data.frame(tabb3[,c( 'min_lat', 'max_lat', 'min_lon', 'max_lon', 'max_speed', 'max_dist_km', 'timing_for_max', 'dist_travel_km', 'duration_trip_day')])[, -10], 2, round, digit = 2))
